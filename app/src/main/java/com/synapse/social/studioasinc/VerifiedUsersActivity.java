...
public class VerifiedUsersActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.verified_users);
	...
	public void _getUsersReference() {
		...
		mLoadingBody.setVisibility(View.VISIBLE);
		{
				...
				mExecutorService.execute(new Runnable() {
						@Override
						public void run() {
								Query getUsersList = FirebaseDatabase.getInstance().getReference("skyline/users").orderByChild("verify").equalTo("true");
