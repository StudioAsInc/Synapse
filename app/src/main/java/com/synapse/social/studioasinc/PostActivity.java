...
public class PostActivity extends AppCompatActivity {
	...
	private LinearLayout ScrollOverLayout;
	private LinearLayout PostSettingLayout;
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		ScrollOverLayout = findViewById(R.id.ScrollOverLayout);
		PostSettingLayout = findViewById(R.id.PostSettingLayout);
