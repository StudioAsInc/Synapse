...
public class ReportRequestsActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.report_requests);
	...
	public void _getUsersReference() {
		...
		mLoadingBody.setVisibility(View.VISIBLE);
		{
				...
				mExecutorService.execute(new Runnable() {
						@Override
						public void run() {
								Query getUsersList = FirebaseDatabase.getInstance().getReference("skyline/admin/user-reports");
	...
	public class MUsersListAdapter extends RecyclerView.Adapter<MUsersListAdapter.ViewHolder> {
		...
		public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
			...
			View _v = _inflater.inflate(R.layout.report_requests_bind, null);
		...
		public void onBindViewHolder(ViewHolder _holder, final int _position) {
			...
			final LinearLayout userInf = _view.findViewById(R.id.userInf);
			...
			final ImageView arrow_ic = _view.findViewById(R.id.arrow_ic);
			...
			final TextView report_count = _view.findViewById(R.id.report_count);
			...
			}
			{
					...
					mExecutorService.execute(new Runnable() {
							@Override
							public void run() {
									DatabaseReference getReference = FirebaseDatabase.getInstance().getReference("skyline/admin/user-reports").child(_data.get((int)_position).get("uid").toString()).child("reporter-users");
											...
											public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
													mMainHandler.post(new Runnable() {
															...
															public void run() {
																	...
																	report_count.setText("Reported by " + mCount + " users");
															}
													});
											}
			...
			profileCardRelative.setOnClickListener(new View.OnClickListener() {
				@Override
				public void onClick(View _view) {
			...
			body.setOnClickListener(new View.OnClickListener() {
				@Override
				public void onClick(View _view) {
					intent.setClass(getApplicationContext(), ReportRequestsPreviewActivity.class);
					intent.putExtra("uid", _data.get((int)_position).get("uid").toString());
					startActivity(intent);
				}
			});
