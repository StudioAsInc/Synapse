...
class c {
	...
	private RequestNetwork rn_qrcode;
	private RequestNetwork.RequestListener _rn_qrcode_request_listener;
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		switch_ic = findViewById(R.id.switch_ic);
		...
		rn_qrcode = new RequestNetwork(this);
		...
		ProfilePageTopBarMenu.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				...
				// Initialize UserProfileMoreBottomSheet and set arguments
				...
				// Configure BottomSheetDialog without showing the first bottom sheet
				com.google.android.material.bottomsheet.BottomSheetDialog bs = new com.google.android.material.bottomsheet.BottomSheetDialog(ProfileActivity.this);
				View bsV = getLayoutInflater().inflate(R.layout.options, null);
				bs.setContentView(bsV);
				...
				final LinearLayout main = bsV.findViewById(R.id.body);
				final LinearLayout bar = bsV.findViewById(R.id.handle);
				final LinearLayout box = bsV.findViewById(R.id.content_box);
				final LinearLayout settings_bs = bsV.findViewById(R.id.settings);
				final LinearLayout share_bs = bsV.findViewById(R.id.share_box);
				final LinearLayout labs_bs = bsV.findViewById(R.id.lab_box);
				final LinearLayout about_bs = bsV.findViewById(R.id.about_box);
				
				//final TextView header = bsV.findViewById(R.id.title);
				//final TextView para = bsV.findViewById(R.id.subtitle);
				final TextView text1 = bsV.findViewById(R.id.subtitle1);
				final TextView text2 = bsV.findViewById(R.id.subtitle2);
				final TextView text3 = bsV.findViewById(R.id.subtitle3);
				final TextView text4 = bsV.findViewById(R.id.subtitle4);
				final TextView text5 = bsV.findViewById(R.id.system_default_text);
				final TextView text6 = bsV.findViewById(R.id.light_text);
				final TextView text7 = bsV.findViewById(R.id.dark_text);
				final TextView text8 = bsV.findViewById(R.id.amoled_text);
				final TextView text9 = bsV.findViewById(R.id.system_default_text);
				final TextView text10 = bsV.findViewById(R.id.light_text);
				
				final LinearLayout div = bsV.findViewById(R.id.devider1);
				final LinearLayout div2 = bsV.findViewById(R.id.devider2);
				final LinearLayout div3 = bsV.findViewById(R.id.devider3);
				
				// Set outside touch dismissal listener
				bs.setOnDismissListener(new DialogInterface.OnDismissListener() {
					    @Override
					    public void onDismiss(DialogInterface dialog) {
						        // This code will be executed when the user dismisses the bottom sheet by tapping outside
						        // You can perform any actions here, like logging or closing the activity
						        Log.d("BottomSheet", "Dismissed by outside touch");
						    }
				});
				bs.setCancelable(true);
				bs.show();
				...
				box.setBackground(new GradientDrawable() {
				...
				}.getIns(45, 0, Color.TRANSPARENT, 0xFFF5F3F8));
				...
				}.getIns(360, 0, Color.TRANSPARENT, 0xFFD7D5DA));
				
				// Configure main layout background
				...
				SketchUi.setColor(0xFFF5F3F8);
				SketchUi.setCornerRadii(new float[]{density * 25, density * 25, density * 24, density * 24, 0, 0, 0, 0});
				main.setElevation(density * 5);
				main.setBackground(SketchUi);
				about_bs.setOnClickListener(new View.OnClickListener() {
					@Override
					public void onClick(View _view) {
				...
				settings_bs.setOnClickListener(new View.OnClickListener() {
					@Override
					public void onClick(View _view) {
						/*
startActivity(intent);
*/
		...
		ProfilePageTabUserInfoBadgesScrollLayoutAccountTypeBadge.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				_openBadgeSheet();
			}
		...
		ProfilePageTabUserInfoBadgesScrollLayoutVerifiedBadge.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				_openBadgeSheet();
			}
		...
		ProfilePageTabUserInfoBadgesScrollLayoutPremiumBadge.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				_openBadgeSheet();
			}
		...
		_rn_qrcode_request_listener = new RequestNetwork.RequestListener() {
			...
			public void onResponse(String _param1, String _param2, HashMap<String, Object> _param3) {
				...
				try{
					bs = new com.google.android.material.bottomsheet.BottomSheetDialog(ProfileActivity.this);
					View bsV;
					bsV = getLayoutInflater().inflate(R.layout.myqr_link_bscv,null );
					bs.setContentView(bsV);
					bs.getWindow().findViewById(R.id.design_bottom_sheet).setBackgroundResource(android.R.color.transparent);
					final ImageView qrImage = (ImageView) bsV.findViewById(R.id.qr_img);
					final TextView name = (TextView) bsV.findViewById(R.id.name);
					final LinearLayout qr_template = (LinearLayout) bsV.findViewById(R.id.qr_template);
					bs.setCancelable(true);
					bs.show();
					Glide.with(getApplicationContext()).load(Uri.parse("https://api.qrserver.com/v1/create-qr-code/?data=".concat(FirebaseAuth.getInstance().getCurrentUser().getUid().concat("?b=q&size=130×130")))).into(qrImage);
