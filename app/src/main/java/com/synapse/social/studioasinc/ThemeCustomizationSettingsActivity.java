...
public class ThemeCustomizationSettingsActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.theme_customization_settings);
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		content_holder = findViewById(R.id.content_holder);
	}
