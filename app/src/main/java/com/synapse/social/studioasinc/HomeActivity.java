...
public class HomeActivity extends AppCompatActivity {
	...
	private ImageView notifications_btn;
...
class c {
	...
	private SharedPreferences spPreloaded;
	...
	private com.google.android.material.bottomsheet.BottomSheetDialog bs1;
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		spPreloaded = getSharedPreferences("spPreloaded", Activity.MODE_PRIVATE);
...
*/
		...
		textview1.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				SketchwareUtil.showMessage(getApplicationContext(), "This feature is under development.");
				/*
...
*/
		...
		miniPostLayoutMoreButton.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				bs = new com.google.android.material.bottomsheet.BottomSheetDialog(HomeActivity.this);
				View bsV;
				bsV = getLayoutInflater().inflate(R.layout.sub_apps_bscv,null );
		...
		LocalPostsBodyList.addOnScrollListener(new RecyclerView.OnScrollListener() {
			@Override
						...
						public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
							if(dataSnapshot.exists()) {
								...
								if (dataSnapshot.child("avatar").getValue(String.class).equals("null")) {
									...
									SketchwareUtil.showMessage(getApplicationContext(), "Please, set your profile picture");
	...
	public void _dark_theme_settings() {
		body.setBackgroundColor(0xFF121212);
		app_name_bar.setTextColor(0xFFEEEEEE);
	}
	
	
	public void _night_theme_settings() {
		body.setBackgroundColor(0xFF283593);
	}
	...
	public void _Buypremium() {
		bs = new com.google.android.material.bottomsheet.BottomSheetDialog(HomeActivity.this);
		View bsV;
		bsV = getLayoutInflater().inflate(R.layout.buypremium_cbsv,null );
		bs.setContentView(bsV);
		bs.getWindow().findViewById(R.id.design_bottom_sheet).setBackgroundResource(android.R.color.transparent);
...
*/
	...
	public void _CreateDialog(final ImageView _icon, final TextView _title_txt, final TextView _sub_txt, final TextView _pos_btn, final TextView _NegativeBtn, final TextView _bgcolor) {
		/*
cd = new AlertDialog.Builder(HomeActivity.this).create();
LayoutInflater cdLI = getLayoutInflater();
View cdCV = (View) cdLI.inflate(R.layout.dialog_m3, null);
cd.setView(cdCV);
final ImageView ic = (ImageView)
cdCV.findViewById(R.id.ic);
final TextView  = (TextView)
cdCV.findViewById(R.id.);
...
ic.setImageResource(R.drawable.default_image);
*/
	}
	...
	public void _payment_method() {
		bs = new com.google.android.material.bottomsheet.BottomSheetDialog(HomeActivity.this);
		View bsV;
		bsV = getLayoutInflater().inflate(R.layout.donate_medium_bscv,null );
		bs.setContentView(bsV);
		bs.getWindow().findViewById(R.id.design_bottom_sheet).setBackgroundResource(android.R.color.transparent);
		final LinearLayout crypto_pay = (LinearLayout) bsV.findViewById(R.id.crypto);
		final LinearLayout beKash = (LinearLayout) bsV.findViewById(R.id.bkash);
		final LinearLayout nagad = (LinearLayout) bsV.findViewById(R.id.nagad);
		final LinearLayout binance = (LinearLayout) bsV.findViewById(R.id.binance);
		final LinearLayout bybit = (LinearLayout) bsV.findViewById(R.id.bybit);
		final LinearLayout rocket = (LinearLayout) bsV.findViewById(R.id.rocket);
		final LinearLayout row1 = (LinearLayout) bsV.findViewById(R.id.row1);
		final LinearLayout app_holder = (LinearLayout) bsV.findViewById(R.id.app_holder);
		final LinearLayout main = (LinearLayout) bsV.findViewById(R.id.main);
		final TextView links = (TextView) bsV.findViewById(R.id.links);
		bs.setCancelable(true);
		bs.show();
		crypto_pay.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				bs.dismiss();
				bs1 = new com.google.android.material.bottomsheet.BottomSheetDialog(HomeActivity.this);
				View bs1V;
				bs1V = getLayoutInflater().inflate(R.layout.crypto_pay_bscv,null );
				bs1.setContentView(bs1V);
				bs1.getWindow().findViewById(R.id.design_bottom_sheet).setBackgroundResource(android.R.color.transparent);
				final TextView number = (TextView) bs1V.findViewById(R.id.number);
				final TextView caution = (TextView) bs1V.findViewById(R.id.caution);
				final TextView network = (TextView) bs1V.findViewById(R.id.network);
				final TextView wallet = (TextView) bs1V.findViewById(R.id.wallet);
				final TextView network_name = (TextView) bs1V.findViewById(R.id.network_name);
				final TextView address = (TextView) bs1V.findViewById(R.id.address);
				final TextView fees = (TextView) bs1V.findViewById(R.id.fees);
				final TextView fee_amount = (TextView) bs1V.findViewById(R.id.fee_amount);
				final TextView amount = (TextView) bs1V.findViewById(R.id.amount);
				bs1.setCancelable(true);
				bs1.show();
				network_name.setTypeface(Typeface.createFromAsset(getAssets(),"fonts/merchantcopydoublesize.ttf"), 0);
				address.setTypeface(Typeface.createFromAsset(getAssets(),"fonts/merchantcopydoublesize.ttf"), 0);
				fee_amount.setTypeface(Typeface.createFromAsset(getAssets(),"fonts/merchantcopydoublesize.ttf"), 0);
				amount.setTypeface(Typeface.createFromAsset(getAssets(),"fonts/merchantcopydoublesize.ttf"), 0);
			}
		});
		beKash.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				bs.dismiss();
				bs1 = new com.google.android.material.bottomsheet.BottomSheetDialog(HomeActivity.this);
				View bs1V;
				bs1V = getLayoutInflater().inflate(R.layout.bkash_pay,null );
				bs1.setContentView(bs1V);
				bs1.getWindow().findViewById(R.id.design_bottom_sheet).setBackgroundResource(android.R.color.transparent);
				final TextView number = (TextView) bs1V.findViewById(R.id.number);
				bs1.setCancelable(true);
		...
		nagad.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				...
				bs1 = new com.google.android.material.bottomsheet.BottomSheetDialog(HomeActivity.this);
				View bs1V;
				bs1V = getLayoutInflater().inflate(R.layout.nagad_pay,null );
				bs1.setContentView(bs1V);
				bs1.getWindow().findViewById(R.id.design_bottom_sheet).setBackgroundResource(android.R.color.transparent);
				final TextView number = (TextView) bs1V.findViewById(R.id.number);
				bs1.setCancelable(true);
		...
		rocket.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				...
				bs1 = new com.google.android.material.bottomsheet.BottomSheetDialog(HomeActivity.this);
				View bs1V;
				bs1V = getLayoutInflater().inflate(R.layout.rocket_pay,null );
				bs1.setContentView(bs1V);
				bs1.getWindow().findViewById(R.id.design_bottom_sheet).setBackgroundResource(android.R.color.transparent);
				final TextView number = (TextView) bs1V.findViewById(R.id.number);
				bs1.setCancelable(true);
		...
		binance.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				bs.dismiss();
				bs1 = new com.google.android.material.bottomsheet.BottomSheetDialog(HomeActivity.this);
				View bs1V;
				bs1V = getLayoutInflater().inflate(R.layout.binance_pay,null );
				bs1.setContentView(bs1V);
				bs1.getWindow().findViewById(R.id.design_bottom_sheet).setBackgroundResource(android.R.color.transparent);
				final TextView number = (TextView) bs1V.findViewById(R.id.number);
				final TextView mail = (TextView) bs1V.findViewById(R.id.mail);
				final TextView phone = (TextView) bs1V.findViewById(R.id.phone);
				final TextView uid = (TextView) bs1V.findViewById(R.id.uid);
				final TextView network_name = (TextView) bs1V.findViewById(R.id.network_name);
				final TextView username = (TextView) bs1V.findViewById(R.id.username);
				bs1.setCancelable(true);
				bs1.show();
				network_name.setTypeface(Typeface.createFromAsset(getAssets(),"fonts/merchantcopydoublesize.ttf"), 0);
				mail.setTypeface(Typeface.createFromAsset(getAssets(),"fonts/merchantcopydoublesize.ttf"), 0);
				username.setTypeface(Typeface.createFromAsset(getAssets(),"fonts/merchantcopydoublesize.ttf"), 0);
				uid.setTypeface(Typeface.createFromAsset(getAssets(),"fonts/merchantcopydoublesize.ttf"), 0);
				phone.setTypeface(Typeface.createFromAsset(getAssets(),"fonts/merchantcopydoublesize.ttf"), 0);
			}
		});
		bybit.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				bs.dismiss();
				bs1 = new com.google.android.material.bottomsheet.BottomSheetDialog(HomeActivity.this);
				View bs1V;
				bs1V = getLayoutInflater().inflate(R.layout.bybit_pay,null );
				bs1.setContentView(bs1V);
				bs1.getWindow().findViewById(R.id.design_bottom_sheet).setBackgroundResource(android.R.color.transparent);
				final TextView number = (TextView) bs1V.findViewById(R.id.number);
				final TextView mail = (TextView) bs1V.findViewById(R.id.mail);
	...
	public void _OpenAndroidDevelopersBlog() {
		AndroidDevelopersBlogURL = "https://web-synapse.pages.dev/docs/premium-features";
	...
	public void _UI() {
		// Icon color filters
		menu.setColorFilter(0xFF445E91, PorterDuff.Mode.MULTIPLY);
	...
	public class StoriesViewAdapter extends RecyclerView.Adapter<StoriesViewAdapter.ViewHolder> {
		...
		public void onBindViewHolder(ViewHolder _holder, final int _position) {
			...
			storiesMyStory.setOnClickListener(new View.OnClickListener() {
				@Override
				public void onClick(View _view) {
					i.setClass(getApplicationContext(), AddStoriesActivity.class);
					startActivity(i);
				}
			});
	...
	public class LocalPostsBodyListAdapter extends RecyclerView.Adapter<LocalPostsBodyListAdapter.ViewHolder> {
		...
		public void onBindViewHolder(ViewHolder _holder, final int _position) {
			...
			final kr.co.prnd.readmore.ReadMoreTextView postMessageTextMiddle = _view.findViewById(R.id.postMessageTextMiddle);
			...
			if (_data.get((int)_position).get("post_type").toString().equals("TEXT") || (_data.get((int)_position).get("post_type").toString().equals("IMAGE") || _data.get((int)_position).get("post_type").toString().equals("VIDEO"))) {
					...
					if (_data.get((int)_position).containsKey("post_image")) {
						...
						//_LoadingImageURL(_data.get((int)_position).get("post_image").toString(), postImage);
