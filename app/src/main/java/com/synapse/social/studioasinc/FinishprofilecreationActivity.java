...
public class FinishprofilecreationActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.finishprofilecreation);
...
initializeLogic();
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		skip_button.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				SketchwareUtil.showMessage(getApplicationContext(), "You have to verify your account");
			}
		});
	...
	private void initializeLogic() {
		...
		_viewGraphics(complete_button, getResources().getColor(R.color.colorPrimary), getResources().getColor(R.color.colorControlHighlight), 300, 0, Color.TRANSPARENT);
	...
	public void onBackPressed() {
		{
			final AlertDialog NewCustomDialog = new AlertDialog.Builder(FinishprofilecreationActivity.this).create();
